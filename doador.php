    ...
    <div class="container">
        <form action="doacao_script.php" method="POST">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="litro" id="1litro" required>
                <label class="form-check-label" for="1litro">
                Menos de 1 litro
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="litro" id="1A2litros" required>
                <label class="form-check-label" for="1A2litros">
                Aproximadamente 1 a 2 litros
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="litro" id="2a5litros" required>
                <label class="form-check-label" for="2a5litros">
                Aproximadamente 2 a 5 litros
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="litro" id="5a10litros" required>
                <label class="form-check-label" for="5a10litros">
                Aproximadamente 5 a 10 litros
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="litro" id="10litros" required>
                <label class="form-check-label" for="10litros">
                Mais de 10 litros
                </label>
            </div><br>
            <div class="mb-3">
                <label for="qtlatas" class="form-label">Quantas latas ou galões serão doadas:</label>
                <input type="text" class="form-control" id="qtlatas" placeholder="" required>
            </div><br>
            <div class="mb-3">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tipo_tinta" id="alvinaria" required>
                <label class="form-check-label" for="alvinaria">
                Alvinaria
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tipo_tinta" id="madeira" required>
                <label class="form-check-label" for="madeira">
                Madeira
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tipo_tinta" id="metal" required>
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tm_embalagem" id="900ml" required>
                <label class="form-check-label" for="900ml">
                900ml
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tm_embalagem" id="3,6litros" required>
                <label class="form-check-label" for="6litros">
                3,6 litos
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tm_embalagem" id="18litros" required>
                <label class="form-check-label" for="18litros">
                18 litros
                </label>
            </div><br>
            <div class="mb-3">
                <label for="qtlatas" class="form-label">Informe a marca da tinta:</label>
