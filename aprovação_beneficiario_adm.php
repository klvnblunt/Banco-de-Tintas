            ...
            <?php
                ...
                if (isset($_GET['id_doação'])) {
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        $insert_sql = "INSERT INTO adm_aprovação (data_validade, qt_litro, qt_latas, cor, tipo, tamanho, marca, nome, contato) 
                        ...
                        if (mysqli_query($conexao, $insert_sql)){
                            ...
                            echo mensagem("Beneficiario aprovada com sucesso! Entre em contato para informar os pontos de coleta de tinta", 'success');
                            } else {
                ...
                ?>
                <a href="painel_beneficiario.php" class="btn btn-primary">Voltar para o paínel de beneficiario</a>
